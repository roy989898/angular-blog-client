    ...
    comments: MyComment[] = [
        {date: new Date(), name: 'Peter', content: 'cccccc', childrenComments: [], icon: this.icon},
        {
            date: new Date(), name: 'Peter', content: 'cccccc', childrenComments: [
                {date: new Date(), name: 'John', content: 'cccccc', childrenComments: [], icon: this.icon},
                {date: new Date(), name: 'Tom', content: 'cccccc', childrenComments: [], icon: this.icon},
                {date: new Date(), name: 'May', content: 'cccccc', childrenComments: [], icon: this.icon},
            ]
            , icon: this.icon
        },
        {date: new Date(), name: 'Peter', content: 'cccccc', childrenComments: [], icon: this.icon},
