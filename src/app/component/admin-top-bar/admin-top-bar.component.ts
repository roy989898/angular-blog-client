...
export class AdminTopBarComponent implements OnInit {
    ...
    constructor(private topBarQuery: TopBarQuery, public tabNameIconService: TabNameIconService, private myRouterService: MyRouterService) {
    }
    ...
    iconClick() {
        // TODO temp
        this.myRouterService.toBLogDetailPage('CCC');
    }
}
